...
func (u *User) CreateNewUser(user domain.User) (uint64, error) {
...
func (u *User) GetUsersById(id uint64) (*domain.User, error) {
	var err error
...
func (u *User) UpdateUsersById(id uint64, user *domain.User) (int, error) {
	var err error
...
func (u *User) GetUsersByEmail(email string) (*domain.User, error) {
...
func (u *User) GetUsersWithPassByid(id uint64) (*domain.User, error) {
	var err error
