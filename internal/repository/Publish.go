...
import (
	...
	domainUser "dev_book_backend/internal/domain/user"
	"errors"
	"time"
)
...
func (u *Follow) PublicPublish(publish domain.Publish) error {
...
func (u *Follow) MyPublish(id uint64) ([]domain.Publish, error) {
...
func (u *Follow) MyPublishById(id_publish, id_author uint64) (*domain.Publish, error) {
...
func (u *Follow) EditPublish(publish domain.Publish, id_publish, id_author uint64) error {
...
func (u *Follow) PublishById(id_publish uint64) (*domain.Publish, error) {
	db := u.sql.QueryRow(`SELECT 
							p.*, 
							u.nick,
							COALESCE(count(lp.publish_id), 0) AS quantity_like
...
func (u *Follow) PublishFollow(id uint64) ([]domain.Publish, error) {
...
func (u *Follow) GetLikePublish(id_publish uint64) ([]domainUser.User, error) {
